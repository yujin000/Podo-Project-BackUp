    ...
    <div class="html">
        <div class="wrap">
            <div id="Header">
                ...
                <div id="GNB">
                    <ul>
                        <li><a class="adminNavi" id="today">공지사항 작성</a></li>
                        <li><a class="adminNavi" id="chart" href="/allList.music?nickname=${loginNickname }">음원 관리</a></li>
                        <li><a class="adminNavi" id="chart">공연 관리</a></li>
                        <li><a class="adminNavi" href="#">회원 관리</a></li>
                        <li><a class="adminNavi" href="/goodsList.goods">멤버십 관리</a></li>
